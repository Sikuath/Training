...
// 39
{ difficulty:"hard", domain:"lentilles", law:"Relation de conjugaison", image:"./images/lens1.jpg", expr:"\\frac{1}{di}-\\frac{1}{do}=\\frac{1}{f}", type:EXPRESSION_TYPES.RECIPROCAL_SUM, lhs:"do", baseVars:["f","do","di"], targetPool:["f","do","di"], answers:{f:"\\frac{do*di}{do-di}", do:"\\frac{di*f}{f-di}", di:"\\frac{f*do}{f+do}"} },
